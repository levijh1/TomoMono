...
#SBATCH --time=72:00:00   # walltime — 3 days; ~120 configs x ~20-30 min each
...
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=8   # OpenMP threads for tomopy reconstruction
#SBATCH --mem-per-cpu=8192M   # 8 GB x 8 CPUs = 64 GB total
